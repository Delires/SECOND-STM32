...
#define    SDA_IN()       {EEPROM_GPIO_PORT_I2C->CRL&=0x0FFFFFFF; EEPROM_GPIO_PORT_I2C->CRL|=(u32)8<28;}  //PA7 上拉输入10输入00   1000=8
#define    SDA_OUT()      {EEPROM_GPIO_PORT_I2C->CRL&=0x0FFFFFFF; EEPROM_GPIO_PORT_I2C->CRL|=(u32)7<28;}  //PA7 开漏01输出50mhz11  0111=7
