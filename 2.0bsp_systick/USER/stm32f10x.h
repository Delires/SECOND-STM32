...
#define GPIOA               ((GPIO_TypeDef *) GPIOA_BASE)  //定义成GPIO_TypeDef结构体类型的指针 结构体的成员就是每递增32位的变量  即MCU的32位寄存器
#define GPIOB               ((GPIO_TypeDef *) GPIOB_BASE)   //                  所以GPIOB->CRH 指向的就是CRH寄存器的地址
